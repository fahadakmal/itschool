                                        ...
                                        @if(count($custom_menus) > 0 )
                                            @foreach($custom_menus as $menu)
                                                ...
                                                @if($menu['id'] == $menu['parent'])
                                                    ...
                                                    <?php 
                                              if(trans('custom-menu.'.$menu_name.'.'.str_slug($menu->label)) == 'custom-menu.nav-menu.contact')
                                              {
                                                    $menuName='Contact Us';
                                              }else{
                                                    $menuName=trans('custom-menu.'.$menu_name.'.'.str_slug($menu->label));
